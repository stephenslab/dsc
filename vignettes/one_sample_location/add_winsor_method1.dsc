...
# This is the same as first_investigation.dsc, except that we add a
# third method for estimating the population mean, the "Winsorized
# mean".
...
winsor: R(y <- psych::winsor.mean(x,trim = trim,na.rm = TRUE))
  trim: 0.1
  x: $data
  $est_mean: y
